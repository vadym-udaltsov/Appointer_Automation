...
public class DeleteLocationFirstStepProcessor implements IProcessor {
    ...
    public List<MessageHolder> processRequest(ProcessRequest request) throws TelegramApiException {
        ...
        return List.of(MessageUtils.holder("Submit Location deletion", ButtonsType.KEYBOARD, holderRequest));
    }
}
